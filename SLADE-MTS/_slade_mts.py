...
class SladeMts(object):
    ...
    def dataTransformation(self, dataSet, listPatterns):
        ...
        ---------
        @param  : dataSet -- dataSet that contains the multivariate timeseries
                  listPatterns -- they are also the windows of each dimension.
        -------
    ...
    def DBScanParametersChoose(selected_features):
        ...
        ---------
        @param  : selected_features -- a matrix that each column represents a feature.
        -------
        @Returns  : df -- a dataframe contains the dbscan result of some parameters.
        -------
        """
