...
'''
@Description:       :
This file is used for the multivariate time series anomaly detection, when parameters
and windows need to be adjusted.
...
class ParametersSelfTuning(object):
    ...
    def windowSplitting(originalWindows, newWindows):
        """
        @description  :
        split windows based on the current window situation
        ---------
        @param  : originalWindows -- original windows
    ...
    def windowCombination(windows):
        """
        @description  :
        combine windows based on the current window situation
        ---------
        @param  : windows -- windows need to be combined
        -------
        @Returns  : new windows
        -------
        """
